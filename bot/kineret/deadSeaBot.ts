...
function isDeadSeaClaimValid(currentClaim: WikiDataClaim) {
  ...
  const isReferenceValid = currentClaim.references?.length === 1
     && currentClaim.references?.[0].snaks?.P854[0].datavalue.value === 'https://data.gov.il/dataset/https-www-data-gov-il-dataset-683/resource/823479b4-4771-43d8-9189-6a2a1dcaaf10';
